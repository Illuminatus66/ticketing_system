...
SECURE_HSTS_SECONDS = 31536000  # 1 year (enforce HTTPS)
SECURE_SSL_REDIRECT = True  # Redirect all HTTP requests to HTTPS

SESSION_COOKIE_SECURE = True  # Use secure-only session cookies
CSRF_COOKIE_SECURE = True  # Use secure-only CSRF cookies
